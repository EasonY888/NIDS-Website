    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('U', 'User'), ('A', 'Admin')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('U', 'User'), ('M', 'Model')], max_length=10, null=True)),
                ('created', models.DateField(auto_now=True)),
                ('session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.chatsession')),
            ],
        ),
        migrations.CreateModel(
            name='UploadedFiles',
